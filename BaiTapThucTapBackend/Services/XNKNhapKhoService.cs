...
namespace BaiTapThucTapBackend.Services
{
    public class XNKNhapKhoService : IXNKNhapKhoService
    {
        ...
        public XNKNhapKhoService(IXNKNhapKhoRepository repoxnk,INhapKhoRepository repo, AppDbcontext context,NormalizeService normalizeService)
        {
            _repoxnk = repoxnk;
            _repo = repo;
            _context = context;
        ...
        public async Task<bool> HandleAdjustmentAsync(CreateXNKNhapKhoRequest model)
        {
            ...
            try
            {
                model.So_Phieu_Nhap_Kho = _normalizeService.Normalize(model.So_Phieu_Nhap_Kho);
